...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://aisocialtools.co/terms",
  },
  robots: {
    index: true,
    follow: true,
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 border border-amber-200 dark:border-amber-800 mt-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">Service Availability</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">User Content</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
                    <h3 className="font-semibold text-slate-900 dark:text-slate-100 mb-2">Your Rights</h3>
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">Prohibited Uses</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">Disclaimer</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">Limitation of Liability</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">Changes to Terms</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-4">Contact Information</h2>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
