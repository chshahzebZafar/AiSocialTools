          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">
                Twitter / X Character Counter — Free, Accurate URL Weighting
              </h1>
              <p className="text-slate-600 dark:text-slate-300">
                Count characters for Twitter and X posts with the correct URL-weighting rule (every link counts as 23 characters). Live count, remaining characters, and an automatic thread split preview.
              </p>
            </div>
          </div>
          <div className="mt-4 flex items-center gap-3 flex-wrap">
            {tool && <FavoriteButton toolId={tool.id} />}
            <ShareButtons title="Twitter / X Character Counter" text="Free Twitter character counter with accurate URL weighting." />
          </div>
        </div>
