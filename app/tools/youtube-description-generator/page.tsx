          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100">
                YouTube Description Generator — Free SEO Description Template
              </h1>
              <p className="text-slate-600 dark:text-slate-300">
                Build a fully-structured YouTube description with hook, chapter timestamps, links, CTA, and hashtags. Stays under the 5,000-character limit. Free, no signup.
              </p>
            </div>
          </div>
          <div className="mt-4 flex items-center gap-3 flex-wrap">
            {tool && <FavoriteButton toolId={tool.id} />}
            <ShareButtons title="YouTube Description Generator" text="Free YouTube description generator with timestamps & hashtags." />
          </div>
        </div>
