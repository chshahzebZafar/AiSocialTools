...
export const metadata: Metadata = {
  ...
  description:
    "Free square footage calculator. Calculate area for rooms, houses, yards, and irregular shapes. Supports feet, inches, meters, and acres. Perfect for flooring, paint, and real estate calculations.",
  keywords: [
