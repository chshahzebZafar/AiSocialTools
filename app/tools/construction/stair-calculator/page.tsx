...
export default function StairCalculatorPage() {
  ...
  async function handleDownloadPDF() {
    ...
    doc.text(`aisocialtools.co  |  ${ts}`, pageW - margin, 11, { align: "right" });
    y = 28;
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Stair Calculator", item: "https://aisocialtools.co/tools/construction/stair-calculator" },
    ],
  };
