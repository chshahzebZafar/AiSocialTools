...
export default function DrywallEstimatorPage() {
  ...
  async function handleDownloadPDF() {
    ...
    doc.text(`aisocialtools.co  ·  ${ts}`, pageW - margin, 12, { align: "right" });
    y = 26;
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Construction", item: "https://aisocialtools.co/tools/construction" },
      { "@type": "ListItem", position: 4, name: "Drywall Estimator", item: "https://aisocialtools.co/tools/construction/drywall-estimator" },
    ],
  };
      ...
      <main className="flex-1">
        ...
        <section className="border-b border-zinc-200 dark:border-zinc-800">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <Link href="/tools/construction" className="inline-flex items-center gap-1.5 text-sm text-zinc-500 hover:text-zinc-950 dark:hover:text-white transition-colors mb-6">
              <ArrowLeft className="w-4 h-4" /> Back to Construction tools
            </Link>
            ...
            <div className="max-w-5xl">
              ...
              <div className="space-y-4 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm sm:text-base">
                ...
                <p>
                  ...
                  <Link href="/tools/construction/lumber-calculator" className="text-indigo-600 dark:text-indigo-400 underline underline-offset-2 hover:text-indigo-700">Lumber Calculator</Link>.
                  {" "}To estimate the concrete slab or floor, use the{" "}
                  <Link href="/tools/construction/concrete-calculator" className="text-indigo-600 dark:text-indigo-400 underline underline-offset-2 hover:text-indigo-700">Concrete Calculator</Link>.
                  {" "}Browse all{" "}
                  <Link href="/tools/construction" className="text-indigo-600 dark:text-indigo-400 underline underline-offset-2 hover:text-indigo-700">Construction tools</Link>.
                </p>
