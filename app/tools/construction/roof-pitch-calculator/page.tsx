...
export default function RoofPitchCalculatorPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Roof Pitch Calculator", item: "https://aisocialtools.co/tools/construction/roof-pitch-calculator" },
    ],
  };
            ...
            <div className="max-w-5xl">
              ...
              <div className="space-y-4 text-zinc-700 dark:text-zinc-300 leading-relaxed text-sm sm:text-base">
                ...
                <p>
                  ...
                  <Link href="/tools/construction/concrete-calculator" className="text-indigo-600 dark:text-indigo-400 underline underline-offset-2 hover:text-indigo-700">
                    Concrete Calculator
                  </Link>{" "}
                  or our{" "}
                  <Link href="/tools/construction/lumber-calculator" className="text-indigo-600 dark:text-indigo-400 underline underline-offset-2 hover:text-indigo-700">
                    Lumber Calculator
                  </Link>{" "}
                  for structural framing costs. We also have a full suite of{" "}
                  <Link href="/tools/construction" className="text-indigo-600 dark:text-indigo-400 underline underline-offset-2 hover:text-indigo-700">
                    Construction tools
                  </Link>{" "}
