...
export default function ConcreteCalculatorPage() {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Concrete Calculator", item: "https://aisocialtools.co/tools/construction/concrete-calculator" },
    ],
  };
      ...
      <main className="flex-1">
        ...
        <section className="bg-zinc-950 dark:bg-zinc-900 border-y border-zinc-200 dark:border-zinc-800">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
            ...
            <ButtonLink href="/tools/construction" variant="primary" size="lg" className="bg-white text-zinc-950 hover:bg-zinc-200">
