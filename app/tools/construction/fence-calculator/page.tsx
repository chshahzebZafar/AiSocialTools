      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Fence Calculator", item: "https://aisocialtools.co/tools/construction/fence-calculator" },
              ],
            }),
          }}
        />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <Link href="/tools/construction/concrete-calculator" className="text-indigo-600 dark:text-indigo-400 hover:underline">
