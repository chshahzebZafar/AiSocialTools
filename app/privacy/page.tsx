...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://socialmediatools.com/privacy",
  ...
  alternates: {
    canonical: "https://socialmediatools.com/privacy",
  },
  robots: {
    index: true,
    follow: true,
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <div className="bg-blue-50 rounded-lg p-6 border border-blue-200 mb-4">
                    <h3 className="font-semibold text-slate-900 mb-2">We Collect Minimal Information</h3>
                ...
                <section>
                  ...
                  <div className="bg-green-50 rounded-lg p-6 border border-green-200">
                    <h3 className="font-semibold text-slate-900 mb-2">Your Content Stays Yours</h3>
                    <p className="text-slate-700">
