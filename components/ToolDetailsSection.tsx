      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {detailCards.map((card) => {
          ...
          return (
            <div
              key={card.id}
              className={`${card.bgColor} rounded-xl p-6 border border-slate-200 hover:shadow-md transition-shadow cursor-pointer group`}
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className={`font-semibold text-slate-900 mb-2 group-hover:${card.color} transition-colors`}>
                    {card.title}
                  </h3>
